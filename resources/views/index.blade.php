...
<header id="home">
    <!-- Background Image -->
    <div class="bg-img" style="background-image: url('./img/wr_background2.jpg');">
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <div class="navbar-brand">
                    <a href="">
                        <img class="logo" src="img/Waritex-Logo.png" alt="logo">
                        <img class="logo-alt" src="img/Waritex-Logo.png" alt="logo">
                        {{--<span>Waritex</span>--}}
                    </a>
                </div>
                <!-- /Logo -->
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="home-content">
                        <h1 class="white-text">Waritex</h1>
                        <p class="white-text" style="color: white">Committed To Excellence
                        </p>
