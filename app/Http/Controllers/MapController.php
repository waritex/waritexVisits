...
, CASE WHEN RegionNo != 'BGH' THEN ('م. ' + RegionNameA) ELSE CityNameA end as city
,
CASE WHEN (t.LastVisitDate > 15 AND t.LastVisitDate <= 28) THEN '{\"fillColor\":\"green\" , \"path\":\"M 0 0 C -2 -20 -10 -22 -10 -30 A 10 10 0 1 1 10 -30 C 10 -22 2 -20 0 0\"}' ELSE
	CASE WHEN (t.LastVisitDate <= 15 AND t.distance < 100 AND t.opened = 1) THEN '{\"fillColor\":\"lawngreen\" , \"path\":\"M 0 0 C -2 -20 -10 -22 -10 -30 A 10 10 0 1 1 10 -30 C 10 -22 2 -20 0 0\"}' ELSE
		CASE WHEN (t.LastVisitDate <= 15 AND t.distance < 100 AND t.opened is NULL) THEN '{\"fillColor\":\"orange\" , \"path\":\"M 0 0 C -2 -20 -10 -22 -10 -30 A 10 10 0 1 1 10 -30 C 10 -22 2 -20 0 0\"}' ELSE
			CASE WHEN (t.LastVisitDate <= 15 AND t.distance > 100) THEN '{\"fillColor\":\"red\" , \"path\":\"M 0 0 C -2 -20 -10 -22 -10 -30 A 10 10 0 1 1 10 -30 C 10 -22 2 -20 0 0\"}' ELSE NULL
			END
		END
	END
END as svg
